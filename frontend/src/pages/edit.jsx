...
import { Segment, Container, Input, TextArea, Form, Checkbox, Button, Label, Modal, Dimmer, Loader, Grid } from 'semantic-ui-react'
                      ...
                      <section>
                        <Form.Field className='flex' >
                          <Input
                            ...
                            value={this.state.formData.classificacao[classificacao.nome].sinais[sinal.identificador] ? this.state.formData.classificacao[classificacao.nome].sinais[sinal.identificador].max : null}
                            onChange={this.handleChange}
                            onBlur={this.handleChange}
                            format="float"
                          ...
                          <Input
                            ...
                            value={this.state.formData.classificacao[classificacao.nome].sinais[sinal.identificador] ? this.state.formData.classificacao[classificacao.nome].sinais[sinal.identificador].min : null}
                            onChange={this.handleChange}
                            onBlur={this.handleChange}
                            format="float"
                          >
                        ...
                        <TextArea
                          ...
                          value={this.state.formData.classificacao[classificacao.nome].sinais[sinal.identificador] ? this.state.formData.classificacao[classificacao.nome].sinais[sinal.identificador].descritor : null}
                          onChange={this.handleChange}
                          onBlur={this.handleChange}
                  ...
                  <Segment>
                    <Form.Field>
                      <Input
                        ...
                        value={this.state.formData.classificacao[classificacao.nome].sintomas[i] ? this.state.formData.classificacao[classificacao.nome].sintomas[i].sintoma : null}
                        onChange={this.handleChange}
                        onBlur={this.handleChange}
                    ...
                    <TextArea
                      ...
                      value={this.state.formData.classificacao[classificacao.nome].sintomas[i] ? this.state.formData.classificacao[classificacao.nome].sintomas[i].descritor : null}
                      onChange={this.handleChange}
                      onBlur={this.handleChange}
